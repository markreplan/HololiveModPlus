...
public class CallShiroganeNoel extends AbstractSummonCard {
    public static final String ID = makeID("CallShiroganeNoel");
    private static final String IMG = cardPath("summon/CallShiroganeNoel.png");
    ...
    private static final int UPGRADED_COST = 3; // Cost after upgrade
