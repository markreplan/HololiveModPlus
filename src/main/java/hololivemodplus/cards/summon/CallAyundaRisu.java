...
public class CallAyundaRisu extends AbstractSummonCard {
    public static final String ID = makeID("CallAyundaRisu");
    private static final String IMG = cardPath("summon/CallAyundaRisu.png");
    ...
    private static final int UPGRADE_PLUS_ATK = 3; // ATK to add after upgrade
