...
public class CallKobo extends AbstractSummonCard {
    public static final String ID = makeID("CallKobo");
    private static final String IMG = cardPath("summon/CallKobo.png");
