...
public class CallTakaneLui extends AbstractSummonCard {
    public static final String ID = makeID("CallTakaneLui");
    private static final String IMG = cardPath("summon/CallTakaneLui.png");
