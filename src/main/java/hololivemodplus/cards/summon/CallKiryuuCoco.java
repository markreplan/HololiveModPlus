...
public class CallKiryuuCoco extends AbstractSummonCard {
    public static final String ID = makeID("CallKiryuuCoco");
    private static final String IMG = cardPath("summon/CallKiryuuCoco.png");
    ...
    private static final int UPGRADED_COST = 4; // Cost after upgrade
