...
public class CallShirakamiFubuki extends AbstractSummonCard {
    public static final String ID = makeID("CallShirakamiFubuki");
    private static final String IMG = cardPath("summon/CallShirakamiFubuki.png");
    ...
    private static final int UPGRADE_PLUS_ATK = 6; // ATK to add after upgrade
    private static final int UPGRADE_PLUS_HP = 6; // HP to add after upgrade
