...
public class CallMurasakiShion extends AbstractSummonCard {
    public static final String ID = makeID("CallMurasakiShion");
    private static final String IMG = cardPath("summon/CallMurasakiShion.png");
    ...
    private static final int UPGRADED_COST = 0; // Cost after upgrade
    private static final int UPGRADE_PLUS_ATK = 2; // ATK to add after upgrade
    private static final int UPGRADE_PLUS_HP = 2; // HP to add after upgrade
