...
public class CallOozoraSubaru extends AbstractSummonCard {
    public static final String ID = makeID("CallOozoraSubaru");
    private static final String IMG = cardPath("summon/CallOozoraSubaru.png");
