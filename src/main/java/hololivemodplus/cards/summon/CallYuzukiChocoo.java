...
public class CallYuzukiChocoo extends AbstractSummonCard {
    public static final String ID = makeID("CallYuzukiChocoo");
    private static final String IMG = cardPath("summon/CallYuzukiChocoo.png");
