...
public class CallAiraniIofi extends AbstractSummonCard {
    public static final String ID = makeID("CallAiraniIofi");
    private static final String IMG = cardPath("summon/CallAiraniIofi.png");
    ...
    private static final int UPGRADE_PLUS_HP = 4; // HP to add after upgrade

    public CallAiraniIofi() {
