...
public class CallZeta extends AbstractSummonCard {
    public static final String ID = makeID("CallZeta");
    private static final String IMG = cardPath("summon/CallZeta.png");
