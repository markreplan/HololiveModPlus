...
public class CallOokamiMio extends AbstractSummonCard {
    public static final String ID = makeID("CallOokamiMio");
    private static final String IMG = cardPath("summon/CallOokamiMio.png");
