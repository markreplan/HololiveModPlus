...
public class CallHoshinovaMoona extends AbstractSummonCard {
    public static final String ID = makeID("CallHoshinovaMoona");
    private static final String IMG = cardPath("summon/CallHoshinovaMoona.png");
