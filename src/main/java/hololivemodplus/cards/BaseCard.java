package hololivemodplus.cards;

import basemod.abstracts.CustomCard;
import hololivemodplus.HololiveModPlus;

import static hololivemodplus.HololiveModPlus.makeID;
import static hololivemodplus.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    HololiveModPlus.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
